...
description: 'Generate a new service and register it with GetIt'
---
...
4. In the central [services file](../../lib/app/services.dart), add a line for quick access to the new service. For example:
